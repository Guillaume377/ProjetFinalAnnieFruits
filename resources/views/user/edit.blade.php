                        ...
                        <div class="card-body">
                            ...
                            @method('PUT')
                                ...
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    ============================================================ -->
                                    <div class="col mb-3">
                                        <label for="telephone" class="col-form-label ms-1"><small>{{ __('Nouveau téléphone') }}</small></label>

                                        <div class="col-md-12">
                                            <input id="telephone" type="text" placeholder="Nouveau téléphone" class="form-control @error('telephone') is-invalid @enderror" name="telephone" value="{{ $user->telephone }}" required autocomplete="telephone" autofocus>
                                    ...
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div id="emailHelp" class="form-text ms-1">minimum 8 caractères dont au moins 1 lettre avec minimum 1 majuscule, 1 chiffre et 1 caractère spécial</div>
                                        ...
                                        ============================================================ -->
                                        <div class="col mb-3">
                                            <label for="password" class="col-form-label ms-1"><small>{{ __('Confirmer le nouveau mot de passe') }}</small></label>
