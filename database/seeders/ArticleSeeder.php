...
class ArticleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Article::create([
            'nom' => 'Ail',
            'titre' =>"Conseils de conservation et préparation",
            'description' => 
        ...
        Article::create([
            'nom' => 'Ananas',
            'titre' =>"L'ananas Victoria, le fruit roi de l'exotisme",
            'description' => "Son goût frais et sucré évoque les îles, son parfum embaume notre cuisine de vacances. 
        ...
        Article::create([
            'nom' => 'Aubergine',
            'titre' => "L'aubergine, un caviar de légume", 
            'description' => 
        ...
        Article::create([
            'nom' => 'Avocat',
            'titre' => "L'avocat, non-coupable de gras", 
            'description' => 
            ...
            il était considéré comme un produit de luxe et boudé pour sa présumée trop importante richesse en lipides. Pourtant aujourd’hui, l’avocat est couramment consommé et en France, nous en sommes particulièrement friands.
        ...
        Article::create([
            'nom' => 'Banane',
            'titre' => "La banane, un fruit qui donne la pêche !",
            'description' =>  
            "Vous connaissez sans doute l’expression courante « avoir la banane » et on espère que vous l’employez souvent ! 
            Cette expression est née à la fois pour la forme de ce fruit qui ressemble à un sourire, mais peut-être aussi pour tous les bienfaits qu’il procure à notre organisme.
        ...
        Article::create([
            'nom' => 'Carotte',
            'titre' => "Carotte, raconte-nous ton histoire !",
            'description' => 
        ...
        Article::create([
            ...
            'titre' => "Le champignon de Paris, le champignon qui a tout bon!",
            'description' => 
            "Cultivé en France depuis le XIXe siècle, le champignon de Paris a su nous convaincre et trouver sa place dans notre terroir français ainsi que dans nos cuisines !
        ...
        Article::create([
            'nom' => 'Concombre',
            'titre' => "Le concombre, un légume hydratant",
            'description' =>  
            ...
            On apprécie depuis longtemps le goût tout doux du concombre frais, dès que le printemps arrive et pour tout l’été. Ce légume devient pendant quelques mois l’ingrédient principal de nos plats.
        ...
        Article::create([
            'nom' => 'Fenouil',
            'titre' => "Le fenouil, une plante mystérieuse… ",
            'description' => 
            ...
            On a donc décidé de lever le voile sur ce légume et de vous donner quelques recettes et astuces de préparation pour l’apprécier à sa juste valeur.
        ...
        Article::create([
            'nom' => 'Figue',
            'titre' => "La Figue, le miel de l’été", 
            'description' => 
            "La figue, fruit de l’été, est là pour nous rafraîchir et nous donner de l’énergie jusqu’à l’automne !
        ...
        Article::create([
            ...
            Le saviez-vous ? Dans l’Antiquité, la fraise était très utilisée dans les produits de beauté pour sa fragrance particulièrement exquise ! Crème, masques ou soin pour les cheveux, la fraise était partout !
        ...
        Article::create([
            'nom' => 'Kiwi',
            'titre' => "Le kiwi, cette petite bombe d'énergie ",
            'description' => 
            ...
            Consommer ce fruit c’est s’assurer un plein d’énergie ! Avant de vous parler de ses bienfaits, on s’est intéressé à ses origines et on vous raconte comment ce fruit a changé maintes fois d’identités au cours de sa vie avant de s’appeler kiwi aujourd’hui !
        ...
        Article::create([
            'nom' => 'Nectarine',
            'titre' => "La nectarine : le « doux nectar » ",
            'description' => 
            "Le nom « nectarine » signifie étymologiquement « doux nectar », un fruit juteux et sucré, très apprécié dans l’ensemble de l’Europe depuis plusieurs siècles.
        ...
        Article::create([
            ...
            'titre' => "La pastèque, la fraîcheur de l'été !", 
            'description' => 
            ...
            Une bonne pastèque doit sonner creux lorsque l’on tapote son écorce. Son aspect doit être brillant et elle doit être lourde.
        ...
        Article::create([
            'nom' => 'Poire Guyot',
            'titre' => "La belle poire",
            'description' =>  
            "Aussi connue pour ses expressions que pour son goût, la poire est cultivée dans le monde entier. Il existe une dizaine de variétés toutes aussi bonnes les unes que les autres.
        ...
        Article::create([
            'nom' => 'Poivron',
            'titre' => "Le poivron aussi a du piquant !", 
            'description' => 
            ...
            Désormais, il est surtout produit en Chine, au Mexique, en Turquie, en Indonésie, en Espagne et aux États-Unis mais il est aussi récolté de juin à septembre dans le sud de la France !
        ...
        Article::create([
            'nom' => 'Pomme Golden',
            'titre' => "Pomme, la belle à croquer !", 
            'description' => 
        ...
        Article::create([
            'nom' => 'Prune noire',
            'titre' => "La prune, le fruit à croquer de l’été !", 
            'description' => 
        ...
        Article::create([
            ...
            Peut-être parce qu’au XIXème siècle on utilise ce légume et sa forme arrondie pour évoquer un sou, une pièce de monnaie de faible valeur. Vous avez trouvé ? C’est le radis !
        ...
        Article::create([
            ...
            Il se présente sous la forme d’un cylindre plat (35 à 37 cm de diamètre, 2,5 cm d’épaisseur) et pèse 2,6 kg environ, vendu non emballé sur paillon.
            ...
            Sa saveur fruitée et de terroir en fait une figure incontournable des plateaux de fromages.
        ...
        Article::create([
            ...
            Il est couvert d’un duvet blanc pouvant laisser apparaître des traces rougeâtres, selon le degré d’affinage. Le camembert de Normandie contient également 45 % de matières grasses sur extrait sec, ce qui représente seulement 20 % sur produit fini.
        ...
        Article::create([
            ...
            'titre' => "Description", 
            'description' => "Le Chabichou du Poitou est un fromage à pâte molle et à croute naturelle de type lactique fait à base de lait cru et entier de chèvre. 
            Ce fromage est produit dans les départements de la Vienne et des Deux-Sèvres ainsi que dans quelques communes du département de la Charente en région Nouvelle-Aquitaine. Le Chabichou du Poitou bénéficie d’une AOC depuis 1990 et d’une AOP depuis 1996.
        ...
        Article::create([
            ...
            'titre' => "Description", 
            'description' => "Le Pont l’Évêque ? C’est l’un des plus anciens fromages de Normandie. Son nom dérive de son origine géographique qui n’est autre que le bourg de Pont-l’Évêque dans le Calvados. C’est aussi sa principale zone de production. 
            Nommé AOP depuis 1996, le Pont l’Évêque est reconnu entre mille pour sa recette ancestrale transmise de génération en génération. Ce fromage au lait de vache présente une pâte molle et homogène avec une croûte lavée. Selon son affinage, cette dernière peut être de couleur jaune orangé ou jaune paille.
        ...
        Article::create([
            ...
            'titre' => "Description", 
            'description' => "Le Reblochon est un fromage au lait cru de vache, à pâte pressée non cuite, qui se présente sous la forme d’un cylindre d’environ 500 g. Il contient environ 27 % de matière grasse sur produit sec. Mais il existe également des “petits” reblochons, d’un poids d’environ 260 g.
            C’est un véritable péché normand aux senteurs florales et fruitées. À la fois doux et crémeux, il révèle des saveurs uniques de terroir : beurré, lacté, légèrement fumé avec des arômes typés de noisettes. Très affiné, ce fromage devient très intense en bouche. 
            ...
            Mais qu’il soit fermier ou laitier, ce fromage est fabriqué à partir de lait de vaches de race Abondance, Montbéliarde et Tarine.
        ...
        Article::create([
            ...
            'titre' => "Description", 
            'description' => "Le Rocamadour est un petit fromage au lait de chèvre entier, à pâte molle à croûte naturelle. Il se présente sous la forme d’un palet d’environ 35 grammes, de 6 cm de diamètre et de 1,6 cm de hauteur.
        ...
        Article::create([
            ...
            'titre' => "Description", 
            'description' => "Le Selles-sur-Cher AOP, fromage de chèvre au lait cru et entier, se reconnaît à sa pâte molle de couleur blanche et à sa croûte naturelle cendrée à la poudre de charbon de bois.
        ...
        Article::create([
            ...
            'titre' => "Description", 
            'description' => "Fromage au lait de vache, le Saint-Nectaire est une petite perle de l’Auvergne. C’est une pâte demi-ferme pressée non cuite, elle est souple sans toutefois être molle. 
            Quant à la croûte fleurie, selon le stade d’affinage, elle peut présenter des taches blanches, jaunes ou rouges. Sachez que le Saint-Nectaire a une odeur rappelant celle des moisissures et du terroir.
            En forme de disque plat de 21 cm de diamètre et 4 cm de hauteur, ce fromage pèse environ 1,7 kg. Il existe un format réduit, le petit Saint-Nectaire, qui pèse environ 600 g. Il contient au minimum 22,50 % de matière grasse sur produit fini.
